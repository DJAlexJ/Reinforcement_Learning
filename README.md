...
¬се конфиги с алгоритмами лежат здесь:
...
1. System requirements Ц redis

    `sudo apt install redis-server`

2. Python requirements Ц OpenAI Gym box2d
...
4. Select config
    ...
    ```bash
    # DQN        Ц off-policy algorithm on discrete LunarLander
    export CONFIG=./rl_gym/config_dqn.yml

    # DDPG       Ц off-policy algorithm on continuous LunarLander
    export CONFIG=./rl_gym/config_ddpg.yml
    # SAC        Ц off-policy algorithm on continuous LunarLander
    export CONFIG=./rl_gym/config_sac.yml
    # TD3        Ц off-policy algorithm on continuous LunarLander
    export CONFIG=./rl_gym/config_td3.yml

    # PPO        Ц on-policy algorithm on discrete LunarLander
    export CONFIG=./rl_gym/config_ppo_discrete.yml
    # PPO        Ц on-policy algorithm on continuous LunarLander
    export CONFIG=./rl_gym/config_ppo_continuous.yml
    # REINFORCE  Ц on-policy algorithm on discrete LunarLander
    export CONFIG=./rl_gym/config_reinforce_discrete.yml
    # REINFORCE  Ц on-policy algorithm on continuous LunarLander
